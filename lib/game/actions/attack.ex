defmodule ExMon.Game.Actions.Attack do
  ...
  def attack_opponent(opponent, move) do
    ...
    |> Game.attacker()
    |> Map.get(:life)
    |> calculate_resultant_life(damage)
  ...
  def calculate_resultant_life(life, damage) when life - damage < 0, do: 0
  def calculate_resultant_life(life, damage), do: life - damage
  ...
  defp update_game(player, opponent, damage) do
    ...
    Status.print_attack_turn_message(opponent, damage)
  end
end
